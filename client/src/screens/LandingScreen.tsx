      ...
      <section className="relative z-10 py-20 px-6 md:px-20 lg:px-52 2xl:px-80 text-center">
        <div className="bg-gradient-to-r from-amber-500/10 to-orange-500/10 border border-amber-500/20 rounded-3xl p-12 max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
            <button className="bg-gradient-to-r from-amber-500 to-orange-500 px-8 py-4 rounded-xl font-semibold text-lg hover:from-amber-400 hover:to-orange-400 transition-all duration-300 cursor-pointer group">
              Get Started Free
              <ArrowRight className="w-5 h-5 ml-2 inline-block group-hover:translate-x-1 transition-transform duration-300" />
            </button>
      ...
      <footer className="relative z-10 border-t border-white/10 py-12 px-6 md:px-20 lg:px-52 2xl:px-80 mt-20">
        ...
        <div className="text-center text-white/40 text-sm mt-8">
          ...
          <span className="text-white/70">
            Made with 🧡 by{" "}
            <a
              href="https://github.com/Krishnanand2517"
              target="_blank"
