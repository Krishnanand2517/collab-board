            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="w-full text-right">
                <button
                  ...
                  className="text-sm text-emerald-500 hover:text-emerald-400 transition-colors duration-200 cursor-pointer tracking-tight"
                >
                  {forgotPassword
              ...
              {forgotPassword ? (
                <button
                  ...
                  className={`w-full px-8 py-4 font-semibold text-base transition-all duration-200
                  ${
